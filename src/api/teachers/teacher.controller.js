...
const indexGet = async (req, res, next) => {
    try {
        // creo una variable teachers con el valor de el resultado de buscar en la colección teachers de mi base de
        //datos utilizando el modelo Teacher en el archivo del modelo de todos los elementos (.find() -> busca todos los 
        //elementos de algún sitio)
...
const getById = async (req, res, next) => {
    try {
        //recogemos el id de los paráetros de la peticion -> req -> request
        const { id } = req.params;
